...
const STATEMENTS = [
  ...
  `alter table public.merchant_link_settings add column if not exists poster_bg_urls jsonb default '[]'::jsonb`,
  `alter table public.merchant_link_settings add column if not exists poster_bg_url text`,
  `alter table public.merchant_link_settings add column if not exists yt_source text`,
  `alter table public.merchant_link_settings add column if not exists yt_enabled boolean default false`,
  `alter table public.merchant_link_settings add column if not exists yt_products jsonb default '{}'::jsonb`,
  `alter table public.merchant_link_settings add column if not exists ig_source text`,
  `alter table public.merchant_link_settings add column if not exists ig_enabled boolean default false`,
  `alter table public.merchant_link_settings add column if not exists ig_products jsonb default '{}'::jsonb`,
  `alter table public.merchant_link_settings add column if not exists pin_source text`,
  `alter table public.merchant_link_settings add column if not exists pin_enabled boolean default false`,
  `alter table public.merchant_link_settings add column if not exists pin_products jsonb default '{}'::jsonb`,
  `alter table public.merchant_link_settings add column if not exists extra_links jsonb default '[]'::jsonb`,
  `alter table public.merchant_link_settings add column if not exists play_store_enabled boolean default true`,
  `alter table public.merchant_link_settings add column if not exists payment_enabled boolean default false`,
  `alter table public.merchant_link_settings add column if not exists payment_provider text default 'upi'`,
  `alter table public.merchant_link_settings add column if not exists payment_upi_id text`,
  `alter table public.merchant_link_settings add column if not exists payment_label text`,
  `alter table public.merchant_link_settings add column if not exists payment_amount_inr numeric`,
  `alter table public.merchant_link_settings add column if not exists digital_shop_enabled boolean default false`,
  `alter table public.merchant_link_settings add column if not exists digital_shop_url text`,
  `alter table public.merchant_link_settings add column if not exists premium_unlocked boolean default false`,
